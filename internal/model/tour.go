...
type Tour struct {
	...
	TourCategoryName    string    `json:"tour_category_name,omitempty"`
	TourCategoryPrice   float64   `json:"tour_category_price,omitempty"`
	RoomID              int64     `json:"room_id"`
	RoomPrice           float64   `json:"room_price,omitempty"`
	RoomBedsCount       int       `json:"room_beds_count,omitempty"`
	CreatedAt           time.Time `json:"created_at"`
	UpdatedAt           time.Time `json:"updated_at"`
}
